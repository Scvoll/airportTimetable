...
exports.Buttons = exports.AirList = exports.ListTitles = undefined;
...
var ListTitles = exports.ListTitles = function ListTitles() {
...
var AirList = exports.AirList = function AirList(props) {
    var rawList = props.list.filter(function (item) {
...
var Buttons = exports.Buttons = function Buttons(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'button',
            { disabled: props.state === 'ARRIVAL',
                onClick: function onClick() {
                    return props.click("ARRIVAL");
                } },
            '\u041F\u0440\u0438\u043B\u0451\u0442'
        ),
        _react2.default.createElement(
            'button',
            { disabled: props.state === 'DEPARTURE',
                onClick: function onClick() {
                    return props.click("DEPARTURE");
                } },
            '\u0412\u044B\u043B\u0435\u0442'
        ),
        _react2.default.createElement(
            'button',
            { disabled: props.state === 'DELAY',
                onClick: function onClick() {
                    return props.click("DELAY");
                } },
            '\u0417\u0430\u0434\u0435\u0440\u0436\u043A\u0438'
        ),
        _react2.default.createElement(
...
var _containers = __webpack_require__(/*! ./containers */ "./src/containers.js");
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            var timer = setInterval(function () {
                _this2.setState(function (prevState) {
                    return { preloader: prevState.preloader += 0.07 };
                });
            }, 100);
            ...
            a.send();
            a.onload = function () {
                var arr = JSON.parse(a.responseText);
                clearInterval(timer);
                this.setState({
                    arrival: arr[0],
                    departure: arr[1]
        ...
        value: function render() {
            ...
            if (this.state.arrival.length !== 0) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_containers.Buttons, { state: this.state.filter,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'tbody',
                            null,
                            _react2.default.createElement(_containers.ListTitles, null),
                            _react2.default.createElement(_containers.AirList, { list: this.setResults(),
                ...
                return _react2.default.createElement(
                    'div',
                    { className: 'preloader',
                        style: { fontSize: this.state.preloader + 'em' } },
                    '\u231B'
                );
            }
        }
        ...
        value: function setResults() {
            switch (this.state.filter) {
                ...
                case "DELAY":
                    return [].concat(_toConsumableArray(this.state.arrival), _toConsumableArray(this.state.departure)).filter(function (item) {
...
var content = __webpack_require__(/*! !../node_modules/css-loader!../node_modules/sass-loader/lib/loader.js!./style.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./styles/style.scss");
